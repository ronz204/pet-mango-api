...
import { GetMyInvitationsHandler } from "./get-invitations.handler";
import { GetMyInvitationsResponse } from "./get-invitations.schema";
...
export const GetMyInvitationsPlugin = new Elysia({ name })
  ...
  .get("/invites", async ({ status, userId, handler }) => {
